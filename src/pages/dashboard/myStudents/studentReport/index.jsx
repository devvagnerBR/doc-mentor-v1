...
const StudentReport = () => {
    ...
    const [report,setReport] = React.useState( JSON.parse( window.localStorage.getItem( 'currentReport' ) ) )
    const [student,setStudent] = React.useState( JSON.parse( window.localStorage.getItem( 'student' ) ) )
